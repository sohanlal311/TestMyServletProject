...
/**
 * Servlet implementation class TestSimpleServlet
 */
@WebServlet(description = "A test simple servlet", urlPatterns = { "/testSimpleServlet" }, initParams = {
		@WebInitParam(name = "DefaultUser", value = "Maahir") })
